...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { cpf: @aluno.cpf, email: @aluno.email, nivel: @aluno.nivel, nome: @aluno.nome, senha: @aluno.senha } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { cpf: @aluno.cpf, email: @aluno.email, nivel: @aluno.nivel, nome: @aluno.nome, senha: @aluno.senha } }
